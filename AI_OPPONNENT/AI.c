...
and sends back continuously the position of the AI palet to be displayed. */
int	main()
{
	static GameData data = NULL;
	static time_t last_time = NULL; //TODO : faire en sorte de l'init que la premiere fois qu'on rentre dans la fonction
